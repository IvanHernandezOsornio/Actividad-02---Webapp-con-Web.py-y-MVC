...
class Ver:
    ...
    def GET(self, nombre): 
        ...
        return config.render.ver(personas) # Envia el registro y renderiza delete.html
    ...
    def POST(self, nombre):
        ...
        config.model_personas.ver_persona(nombre) # Borra el registro del nombre seleccionado
